                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group pt-1">
                                                <input type="text" id="descricao" class="form-control" value="{{ $noticiaAtual->titulo ?? '' }}" name="titulo" placeholder="Informe o nome da tag ex: Futebol" minleght="5" maxleght="50">
                                            </div>
                                        </div>
                                    </div>
            ...
            <section class="section">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Fotos incluidas - Clique na foto para abrir as opções - <button type="button" class="btn btn-success block" data-bs-toggle="modal" data-bs-target="#modalAdicionarFoto">
                                        Adicionar Foto
                                    </button></h5>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card-body">
                                        <div class="card">
                                            <div class="card-content">
                                                <a href="#opcoesFoto{{ $foto->id }}" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="opcoesFoto">
                                            ...
                                            <div class="card-footer justify-content-center collapse mb-4" id="opcoesFoto{{ $foto->id }}" style="">
                                                <button type="button" class="btn btn-primary block" data-bs-toggle="modal" data-bs-target="#modalEditarFoto{{ $foto->id }}">
                                                    Editar
                                                </button>

                                                <button type="button" class="btn btn-danger block" data-bs-toggle="modal" data-bs-target="#modalExclusao{{ $foto->id }}">
                                                    Excluir
                                                </button>
                                        ...
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <div class="form-group">
                                                <select class="choices form-select multiple-remove" name="tags[]" multiple="multiple">
                                                    <optgroup label="tags">
                                                        @foreach ($tags as $tag)
                                                        <option value="{{ $tag->descricao }}" @foreach ($noticiaAtual->tags as $tagAtual)
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <div class="col-sm-12 d-flex justify-content-end">
                                                ...
                                                <a href="{{ route('noticias.index') }}" class="btn btn-light-danger me-1 mb-1">Cancelar</a>
                                            </div>
                                        </div>
...
<div class="modal fade" id="modalAdicionarFoto" tabindex="-1" aria-labelledby="modaltitleAdicionar" style="display: none;" aria-hidden="true">
...
<div class="modal fade" id="modalEditarFoto{{ $foto->id }}" tabindex="-1" aria-labelledby="modaltitleEditar" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
...
{{-- MODAL EXCLUSAO --}}
@foreach ($noticiaAtual->fotos as $foto)
<div class="modal fade" id="modalExclusao{{ $foto->id }}" tabindex="-1" aria-labelledby="modaltitleExclusao" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                        ...
                        <table class="table table-striped" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge {{ $comentario->status->corStatus }}">{{ $comentario->status->descricao }}</span>
                                    </td>
                                    <td class="text-center">
                                        <form action="{{ route('noticiasComentarios.update', $comentario->id) }}" method="post">
                                            @csrf
                                            @method('patch')
                                            <input type="hidden" id="noticia_id" name="noticia_id" value={{ $noticiaAtual->id }}>

                                            <input type="hidden" id="id" name="id" value={{ $comentario->id }}>
                                            <input type="hidden" id="noticia_comentario_status_id" name="noticia_comentario_status_id" value={{ $comentario->noticia_comentario_status_id }}>

                                            <button data-bs-toggle="tooltip" data-bs-placement="top" @if ($comentario->noticia_comentario_status_id == 1 || $comentario->noticia_comentario_status_id == 3) title="Bloquear" type="submit"
